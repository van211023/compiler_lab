...
struct Operand_ {
    ...
    enum {OP_VARIABLE, OP_CONSTANT, OP_LABEL, OP_TEMP, 
...
struct InterCode_
{
    ...
    enum { IR_ASSIGN, //f
    IR_ADD, IR_SUB, IR_DIV ,IR_MUL, //finish
    IR_IF_GOTO, IR_GOTO, //f
    IR_DEC, //f
    IR_FUNCTION, //f 
    IR_LABEL, //f 
    IR_RETURN, 
    ...
    IR_WRITE, //f
    IR_PARAM,  //f
    IR_GET_ADDRESS, //x = &y    //f
    IR_ASSIGN2CONTENT, //*x = y   //f
    IR_GET_CONTENT,  //x = *y   //f
    IR_ASSIGN_BT_ADDRESS //*x = *y //f
    } kind;
    union {
