...
#line 91 "build/generate/IR_parse/IR_syntax.tab.c"
...
#line 188 "build/generate/IR_parse/IR_syntax.tab.c"
...
#if IR_YYDEBUG || YYERROR_VERBOSE || 1
/* YYTNAME[SYMBOL-NUM] -- String name of the symbol SYMBOL-NUM.
   First, the terminals, then, starting at YYNTOKENS, nonterminals.  */
static const char *const yytname[] =
{
  "$end", "error", "$undefined", "EOL", "COLON", "FUNCTION", "LABEL",
  "SHARP", "INT", "ASSIGN", "STAR", "OP", "IF", "RELOP", "ADDR_OF", "GOTO",
  "RETURN", "DEC", "ARG", "CALL", "PARAM", "READ", "WRITE", "ID",
  "$accept", "IR_globol", "IR_program", "IR_function", "IR_stmt", "IR_val",
  "val_deref", "IR_val_rs", "IR_var", "IR_label", "MUL_EOL", YY_NULLPTR
};
#endif
...
#line 1398 "build/generate/IR_parse/IR_syntax.tab.c"
    break;
...
#line 1408 "build/generate/IR_parse/IR_syntax.tab.c"
    break;

  case 4:
#line 75 "src/IR_parse/IR_syntax.y"
                                                        { (yyval.IR_program_ptr_node) = NEW(IR_program); }
#line 1414 "build/generate/IR_parse/IR_syntax.tab.c"
    break;
...
#line 1420 "build/generate/IR_parse/IR_syntax.tab.c"
    break;
...
#line 1522 "build/generate/IR_parse/IR_syntax.tab.c"
    break;
...
#line 1541 "build/generate/IR_parse/IR_syntax.tab.c"
    break;

  case 25:
#line 108 "src/IR_parse/IR_syntax.y"
                                                        { (yyval.IR_val_node) = (yyvsp[0].IR_val_node); }
#line 1547 "build/generate/IR_parse/IR_syntax.tab.c"
    break;

  case 26:
#line 109 "src/IR_parse/IR_syntax.y"
                                                        { (yyval.IR_val_node) = (yyvsp[0].IR_val_node); }
#line 1553 "build/generate/IR_parse/IR_syntax.tab.c"
    break;
...
#line 1564 "build/generate/IR_parse/IR_syntax.tab.c"
    break;

  case 28:
#line 116 "src/IR_parse/IR_syntax.y"
                                                        { (yyval.IR_var_node) = get_IR_var((yyvsp[0].id)); free((yyvsp[0].id)); }
#line 1570 "build/generate/IR_parse/IR_syntax.tab.c"
    break;

  case 29:
#line 118 "src/IR_parse/IR_syntax.y"
                                                        { (yyval.IR_label_node) = get_IR_label((yyvsp[0].id)); free((yyvsp[0].id)); }
#line 1576 "build/generate/IR_parse/IR_syntax.tab.c"
    break;


#line 1580 "build/generate/IR_parse/IR_syntax.tab.c"
